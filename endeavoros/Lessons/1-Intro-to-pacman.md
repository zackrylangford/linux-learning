Awesome—let’s dive into your Wednesday: Arch Command Mastery – Lesson 1.


🟢 Lesson 1: Intro to pacman Mastery
...
pacman -Qe
Shows packages you installed manually
Search for a package
pacman -Ss <term>
Search in synced repositories
Get package details
pacman -Qi <package>
See version, install date, and dependencies
List files in a package
pacman -Ql <package>
See what files were installed and where
Find out which pkg owns a file
pacman -Qo <path>
Useful for debugging files like /usr/bin/python
Remove a package and its deps
sudo pacman -Rns <package>
Cleanly uninstall with unused deps

✅ Practice Exercise (20 Minutes)
Search for a package of interest
Example: try htop, neofetch, or something fun like cowsay
pacman -Ss htop

Install it and inspect the details
sudo pacman -S htop
pacman -Qi htop

Find where its files were placed
pacman -Ql htop

Use the program, then remove it
htop  # run it
